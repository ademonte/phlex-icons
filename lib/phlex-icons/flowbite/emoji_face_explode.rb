...
module PhlexIcons
  module Flowbite
    class EmojiFaceExplode < PhlexIcons::Flowbite::Base
      def solid
        svg(
          **attrs,
      ...
      def outline
        svg(
          **attrs,
          ...
          s.path(fill: 'currentColor', d: 'M12 17a2 2 0 0 1 2 2h-4a2 2 0 0 1 2-2Z')
          s.path(
            stroke: 'currentColor',

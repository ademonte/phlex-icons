...
module PhlexIcons
  module Flowbite
    class FoodBeverageEgg < PhlexIcons::Flowbite::Base
      def solid
        svg(
          **attrs,
        ...
        svg(
          **attrs,
          ...
          s.path(
            ...
            stroke_width: '2',
            d:
              'M10.0001 13c0-.8883.4022-2.3826 1-3.27163M18.05 14c0 3.3137-2.6862 6-6 6-3.31366 0-5.99995-2.6863-5.99995-6S8.73634 4 12.05 4c3.3138 0 6 6.6863 6 10Z'
          )
        end
      end
    end

...
module PhlexIcons
  module Flowbite
    class FoodBeverageBowlRice < PhlexIcons::Flowbite::Base
      def solid
        svg(
          **attrs,
          ...
          s.path(
            fill: 'currentColor',
            d:
              'M20.6134 14.6222c.1145-.3088-.1249-.6222-.4542-.6222H3.84086c-.32935 0-.56875.3134-.45429.6222.76918 2.0753 2.462 3.7423 4.59004 4.6741V20c0 .5523.44772 1 1 1h6.04679c.5523 0 1-.4477 1-1v-.7037c2.128-.9318 3.8209-2.5988 4.59-4.6741Z'
          )
        end
      end

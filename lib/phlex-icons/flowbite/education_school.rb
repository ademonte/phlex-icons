...
module PhlexIcons
  module Flowbite
    class EducationSchool < PhlexIcons::Flowbite::Base
      def solid
        svg(
          **attrs,
          ...
          s.path(
            d:
              'm6 10.5237-2.27075.6386C3.29797 11.2836 3 11.677 3 12.125V20c0 .5523.44772 1 1 1h2V10.5237Zm12 0 2.2707.6386c.4313.1213.7293.5147.7293.9627V20c0 .5523-.4477 1-1 1h-2V10.5237Z'
          )
          s.path(
            fill_rule: 'evenodd',
            d:
